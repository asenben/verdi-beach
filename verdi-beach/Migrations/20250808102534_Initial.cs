    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationZones", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationZoneId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_ReservationZones_ReservationZoneId",
                        column: x => x.ReservationZoneId,
                        principalTable: "ReservationZones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.InsertData(
                table: "ReservationZones",
                columns: new[] { "Id", "Capacity", "Name" },
                values: new object[,]
                {
                    { 1, 10, "Шезлонг с чадър и маса" },
                    { 2, 5, "Голяма шатра" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ReservationZoneId",
                table: "Reservations",
                column: "ReservationZoneId");
        }
